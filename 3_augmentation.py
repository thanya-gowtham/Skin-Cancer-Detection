"""
    This file used to add augmented images to our dataset for classes with lack of images according to the output of the "visualization".
"""
import pickle
import numpy as np
...
f = open("/content/drive/MyDrive/skin_cancer_data/after_aug/x_train", "wb")
pickle.dump(x_train, f)
f.close()
f = open("/content/drive/MyDrive/skin_cancer_data/after_aug/y_train", "wb")
pickle.dump(y_train, f)
f.close()

f = open("/content/drive/MyDrive/skin_cancer_data/after_aug/x_val", "wb")
pickle.dump(x_val, f)
f.close()
f = open("/content/drive/MyDrive/skin_cancer_data/after_aug/y_val", "wb")
pickle.dump(y_val, f)
f.close()

f = open("/content/drive/MyDrive/skin_cancer_data/after_aug/x_test", "wb")
pickle.dump(x_test, f)
f.close()
f = open("/content/drive/MyDrive/skin_cancer_data/after_aug/y_test", "wb")
